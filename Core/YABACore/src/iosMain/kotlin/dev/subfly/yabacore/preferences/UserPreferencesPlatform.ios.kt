...
internal actual suspend fun migratePlatformPreferencesIfNeeded(store: UserPreferencesStore) {
    ...
    dataStore.edit { prefs ->
        ...
        prefs[UserPreferenceKeys.preferredTheme] = enumFromOrdinal(
        ...
        prefs[UserPreferenceKeys.preferredContentAppearance] = enumFromOrdinal(
            standard.intOrDefault(
        ...
        prefs[UserPreferenceKeys.preferredCardImageSizing] = enumFromOrdinal(
            standard.intOrDefault(
        ...
        prefs[UserPreferenceKeys.preferredCollectionSorting] = enumFromOrdinal(
            standard.intOrDefault(
        ...
        prefs[UserPreferenceKeys.preferredBookmarkSorting] = enumFromOrdinal(
            standard.intOrDefault(
        ...
        prefs[UserPreferenceKeys.preferredSortOrder] = enumFromOrdinal(
            standard.intOrDefault(
        ...
        prefs[UserPreferenceKeys.preferredFabPosition] = enumFromOrdinal(
            standard.intOrDefault(
        ...
        val simplifiedShare = appGroup?.boolOrDefault(
            CoreConstants.Settings.USE_SIMPLIFIED_SHARE,
            false,
        ) ?: standard.boolOrDefault(CoreConstants.Settings.USE_SIMPLIFIED_SHARE, false)
