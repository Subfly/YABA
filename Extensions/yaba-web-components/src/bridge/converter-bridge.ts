...
import { GlobalWorkerOptions, getDocument, PDFDateString } from "pdfjs-dist/legacy/build/pdf.min.mjs"
import pdfWorkerUrl from "@/workers/pdfjs-converter-worker-entry.ts?worker&url"
