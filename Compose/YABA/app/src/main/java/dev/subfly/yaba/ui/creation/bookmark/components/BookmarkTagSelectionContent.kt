        ...
        extraContent = {
            TextButton(
                ...
                Row(
                    ...
                    Text(
                        text = stringResource(
                            id = if (selectedTags.isEmpty()) {
                                R.string.create_bookmark_add_tags
                            } else {
                                R.string.create_bookmark_edit_tags
                            }
                        ),
                    )
                }
    ...
    if (selectedTags.isEmpty()) {
        Box(
            ...
            NoContentView(
                ...
                iconName = "tag-01",
                labelRes = R.string.create_bookmark_no_tags_selected_title,
                message = { Text(text = stringResource(R.string.create_bookmark_no_tags_selected_description)) },
            )
        }
    } else {
